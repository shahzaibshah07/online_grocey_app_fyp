...
import com.example.shahzaib.onlinegroceryapp.Activities.More;
...
public class MyCustomAdapter extends RecyclerView.Adapter<MyCustomAdapter.ContactViewHolder> {
    ...
    private ArrayList<Categories> categoriesPOJOArralist;
    private Context context;
    private Categories categoriesPOJO;

    public MyCustomAdapter(Context context, ArrayList<Categories> categoriesPOJOArralist) {
