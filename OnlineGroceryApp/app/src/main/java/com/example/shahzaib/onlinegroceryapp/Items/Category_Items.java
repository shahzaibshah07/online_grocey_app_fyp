...
public class Category_Items {
    ...
    public Category_Items(String itemName) {
    ...
    public Category_Items(String itemImage, Integer itemPrice, String itemName, String itemWeight, String itemMRPStrikePrice, boolean addedTocart) {
    ...
    public Category_Items(String itemImage, Integer itemPrice, String itemName, String itemWeight, String itemMRPStrikePrice, Integer buttonItemCount, String categoryName, Integer totalItemAmount, String itemCatName, String plusMinusButton, boolean addedTocart) {
        this.itemImage = itemImage;
        this.itemPrice = itemPrice;
        this.itemName = itemName;
        this.itemWeight = itemWeight;
