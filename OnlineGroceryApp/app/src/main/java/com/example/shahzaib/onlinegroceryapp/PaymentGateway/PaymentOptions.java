...
import com.example.shahzaib.onlinegroceryapp.Activities.HomePage;
...
public class PaymentOptions extends AppCompatActivity {
    ...
    String payeeName = "SyedShahzaibBasir";
    String transactionNote = "UPI Payment";
    String amount;
    String currencyUnit = "INR";
    String appName = "OnlineGroceryApp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bhimcv = findViewById(R.id.easypaisa);
        phonePecv = findViewById(R.id.jazzcash);
        ...
        String finalAmountTxt = "Rs" + finalAmount;
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        order.setName(name);
                        order.setCity(city);
                        order.setCurrentDate(CurrentDate);
