package com.example.shahzaib.onlinegroceryapp.ForgotPass;
...
import com.example.shahzaib.onlinegroceryapp.Activities.Login;
            ...
            public void onClick(View view) {
                ...
                if (count == 1) {
                    ...
                    if (TextUtils.isEmpty(email.getText().toString()) && TextUtils.isEmpty(mobile.getText().toString())) {
                        ...
                        mobile.setError("mobile must be of 11 digits");
                        count = 0;
...
//                        });
    ...
    public boolean checkIfMobileandEmailExist(String mobile, String email, DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot data : dataSnapshot.getChildren()) {
            ...
            my.setMobile(Objects.requireNonNull(data.getValue(My.class)).getMobile());
            my.setEmail(Objects.requireNonNull(data.getValue(My.class)).getEmail());

            if (my.getMobile().equals(mobile) && my.getEmail().equals(email)) {
                return true;
            }
        }
        return false;
