...
public class RecyclerAdapterForExpandableList extends RecyclerView.Adapter<RecyclerAdapterForExpandableList.MyViewHolder> {
    ...
    private DatabaseReference databaseReference, databaseReferenceForCategory, databaseReferenceForSearch,Root1;
    private More more1;
    private String catName, itemCatName;
    private String userMobile;
    SharedPreferences sharedPreferences;

    RecyclerAdapterForExpandableList(Context mContext, ArrayList<More> moreArrayList, String catName, String itemCatName) {
    ...
    public void onBindViewHolder(final RecyclerAdapterForExpandableList.MyViewHolder holder, final int position) {
        ...
        Root1 =FirebaseDatabase.getInstance().getReference("data").child("users").child(userMobile).child("cartStatus").child("totalCount");
        ...
        String mrp = "Rs" + more.getItemPrice();
        holder.mrp.setText(mrp);

        String strike_MRP = "Rs" + more.getItemMRPStrikePrice();
        ...
        if (more.getButtonItemCount() == 0) {
            ...
            String addBtn = more.getButtonItemCount() + "";
        ...
        holder.addPlusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                final DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference("data").child("users").child(userMobile).child("products").child(catName).child(itemCatName).child(more1.getItemName()).child("buttonItemCount");
                    ...
                    public Transaction.Result doTransaction(@NonNull MutableData mutableData) {
                        ...
                        if (v != null && v.equals(0)) {
                            ...
                            if (count != null) {
                                ...
                                more2.setItemCatName(itemCatName);
