...
import com.example.shahzaib.onlinegroceryapp.Adapter.RecyclerAdapter;
        ...
        databaseReferenceMore.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                    ...
                    ArrayList<com.example.shahzaib.onlinegroceryapp.Class.More> moreArrayList = new ArrayList<>();
                    if (firebaseCategoryName.equals(categoryName)) {
                        ...
                        for (DataSnapshot dataSnapshot3 : dataSnapshot2.getChildren()) {
                            ...
                            for (DataSnapshot data2 : dataSnapshot3.getChildren()) {
                                com.example.shahzaib.onlinegroceryapp.Class.More more = new com.example.shahzaib.onlinegroceryapp.Class.More();
                                ...
                                more.setItemCatName(data2.child("itemCatName").getValue(String.class));
                            ...
                            customAdapter = new RecyclerAdapter(More.this, moreArrayList, firebaseCategoryName);
